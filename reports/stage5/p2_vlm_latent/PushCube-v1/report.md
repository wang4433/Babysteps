...
- n_episodes: 50
- frozen_factor_preservation: **0.700**
- unnecessary_factor_change: **0.300**
- fixed_oracle_factor_rate: 0.980
- final_success_rate: **0.680**
- parse_failure_rate: 0.000
- preservation (mean over non-implicated factors): **0.940**
- unnecessary_changes_rate (mean): 0.060
- harmful_changes_rate (mean): 0.047

## Gates

- **C1 attribution ≥ rule-table**: 1.000 vs 1.000 → PASS
- **C1 preservation ≥ C2 preservation** (Δ = +30.0pp; PASS if Δ ≥ 0)
- **C1 success ≥ C2 success within 5pp** (Δ = +28.0pp; PASS if Δ ≥ -5)
- **C1 selectivity-preservation ≥ C2** (mean preservation Δ = +6.0pp; PASS if Δ ≥ 0)
