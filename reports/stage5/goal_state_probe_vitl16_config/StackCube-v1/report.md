...
- Encoder: `dinov3_vitl16` spatial_mean (the deployed P1 encoder).
...
|---|---|---|---|---|---|---|
| `global_dino (spatial_mean)` | 1024 | 0.500 | 0.450 | 1.000 ± 0.000 | 0.992 ± 0.017 | PASS |

## Verdict

- IntentHead-CV **0.992** vs majority **0.500**, shuffled **0.692**, gate **0.90**.
