...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.542 | 0.642 ± 0.086 | 0.533 ± 0.049 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.650 | 0.825 ± 0.067 | 0.825 ± 0.081 | FAIL |
| `first_last` | 768 | 0.500 | 0.592 | 0.683 ± 0.107 | 0.617 ± 0.116 | FAIL |
| `final_frame` | 768 | 0.500 | 0.583 | 0.767 ± 0.122 | 0.758 ± 0.107 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.533** (gate 0.90); best final-state pooling **`last5_mean` 0.825**.
- PARTIAL — even the best pooling (`last5_mean` 0.825) lifts over chance but misses the 0.90 gate. goal_state is only weakly clip-groundable; not a clean latent cell.
