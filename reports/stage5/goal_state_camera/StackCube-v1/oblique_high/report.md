...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.583 | 0.667 ± 0.099 | 0.633 ± 0.116 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.717 | 0.808 ± 0.068 | 0.792 ± 0.053 | FAIL |
| `first_last` | 768 | 0.500 | 0.658 | 0.717 ± 0.116 | 0.667 ± 0.059 | FAIL |
| `final_frame` | 768 | 0.500 | 0.633 | 0.775 ± 0.086 | 0.733 ± 0.090 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.633** (gate 0.90); best final-state pooling **`last5_mean` 0.792**.
- PARTIAL — even the best pooling (`last5_mean` 0.792) lifts over chance but misses the 0.90 gate. goal_state is only weakly clip-groundable; not a clean latent cell.
