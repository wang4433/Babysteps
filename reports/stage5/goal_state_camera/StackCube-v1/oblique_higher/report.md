...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.550 | 0.625 ± 0.095 | 0.575 ± 0.122 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.558 | 0.808 ± 0.077 | 0.792 ± 0.059 | FAIL |
| `first_last` | 768 | 0.500 | 0.575 | 0.692 ± 0.042 | 0.600 ± 0.077 | FAIL |
| `final_frame` | 768 | 0.500 | 0.608 | 0.783 ± 0.089 | 0.767 ± 0.057 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.575** (gate 0.90); best final-state pooling **`last5_mean` 0.792**.
