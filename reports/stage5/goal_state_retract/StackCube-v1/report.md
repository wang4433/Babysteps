...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.558 | 0.700 ± 0.031 | 0.633 ± 0.076 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.667 | 0.825 ± 0.067 | 0.817 ± 0.073 | FAIL |
| `first_last` | 768 | 0.500 | 0.600 | 0.708 ± 0.075 | 0.683 ± 0.094 | FAIL |
| `final_frame` | 768 | 0.500 | 0.642 | 0.792 ± 0.075 | 0.758 ± 0.049 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.633** (gate 0.90); best final-state pooling **`last5_mean` 0.817**.
