...
- n=120 (60 seeds x 2 demo CLIPS), label dist {'cubeA_on_cubeB': 60, 'cube_at_target': 60} (majority 0.500); place-near drop = cubeB.xy + 0.08 (balanced).
...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.575 | 0.733 ± 0.033 | 0.650 ± 0.077 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.625 | 0.800 ± 0.049 | 0.817 ± 0.068 | FAIL |
| `first_last` | 768 | 0.500 | 0.608 | 0.700 ± 0.061 | 0.708 ± 0.075 | FAIL |
| `final_frame` | 768 | 0.500 | 0.567 | 0.792 ± 0.075 | 0.792 ± 0.070 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.650** (gate 0.90); best final-state pooling **`last5_mean` 0.817**.
