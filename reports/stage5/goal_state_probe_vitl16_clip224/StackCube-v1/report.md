...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 1024 | 0.500 | 0.608 | 0.717 ± 0.072 | 0.692 ± 0.094 | FAIL |
| `last5_mean` | 1024 | 0.500 | 0.633 | 0.825 ± 0.081 | 0.800 ± 0.061 | FAIL |
| `first_last` | 1024 | 0.500 | 0.650 | 0.750 ± 0.087 | 0.717 ± 0.100 | FAIL |
| `final_frame` | 1024 | 0.500 | 0.675 | 0.750 ± 0.079 | 0.767 ± 0.073 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.692** (gate 0.90); best final-state pooling **`last5_mean` 0.800**.
- PARTIAL — even the best pooling (`last5_mean` 0.800) lifts over chance but misses the 0.90 gate. goal_state is only weakly clip-groundable; not a clean latent cell.
