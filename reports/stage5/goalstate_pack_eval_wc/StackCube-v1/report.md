...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.550 | 0.730 ± 0.112 | 0.570 ± 0.087 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.440 | 0.890 ± 0.066 | 0.870 ± 0.087 | FAIL |
| `first_last` | 768 | 0.500 | 0.500 | 0.770 ± 0.040 | 0.710 ± 0.080 | FAIL |
| `final_frame` | 768 | 0.500 | 0.490 | 0.820 ± 0.068 | 0.810 ± 0.058 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.570** (gate 0.90); best final-state pooling **`last5_mean` 0.870**.
- PARTIAL — even the best pooling (`last5_mean` 0.870) lifts over chance but misses the 0.90 gate. goal_state is only weakly clip-groundable; not a clean latent cell.
