...
- Encoder: `dinov3_vitb16` spatial_mean @ resolution 512 (224 = the deployed P1 encoder exactly, so a PASS is deployment-honest).
...
|---|---|---|---|---|---|---|
| `global_dino (spatial_mean)` | 768 | 0.500 | 0.400 | 0.950 ± 0.031 | 0.942 ± 0.020 | PASS |

## Verdict

- IntentHead-CV **0.942** vs majority **0.500**, shuffled **0.392**, gate **0.90**.
