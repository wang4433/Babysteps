...
|---|---|---|---|---|---|---|
| `spatial_mean (all)` | 768 | 0.500 | 0.617 | 0.692 ± 0.042 | 0.675 ± 0.031 | FAIL |
| `last5_mean` | 768 | 0.500 | 0.650 | 0.817 ± 0.073 | 0.808 ± 0.068 | FAIL |
| `first_last` | 768 | 0.500 | 0.583 | 0.758 ± 0.067 | 0.700 ± 0.085 | FAIL |
| `final_frame` | 768 | 0.500 | 0.575 | 0.783 ± 0.072 | 0.758 ± 0.067 | FAIL |

## Verdict

- Deployed `spatial_mean (all)` IntentHead-CV **0.675** (gate 0.90); best final-state pooling **`last5_mean` 0.808**.
- PARTIAL — even the best pooling (`last5_mean` 0.808) lifts over chance but misses the 0.90 gate. goal_state is only weakly clip-groundable; not a clean latent cell.
