# Stage-5 P1 — Vision-grounded G1 (V-JEPA 2.1 ViT-L/16 (SHUFFLED-TIME control))

Input Z: 1024-dim V-JEPA 2.1 ViT-L/16 (SHUFFLED-TIME control) features (token_mean pool over demo frames).
...
| object_motion | geometric | 4 | 200 | 0.27 | 0.23 | 0.56 ± 0.26 | FAIL |
