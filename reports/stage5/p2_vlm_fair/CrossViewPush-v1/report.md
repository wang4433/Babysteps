# Stage-5 P2 VLM attribution — CrossViewPush-v1

- Rule-table attribution accuracy (baseline): **0.000**
...
- **C1 attribution ≥ rule-table**: 1.000 vs 0.000 → PASS
- **C1 preservation ≥ C2 preservation** (Δ = +0.0pp; PASS if Δ ≥ 0)
- **C1 success ≥ C2 success within 5pp** (Δ = +0.0pp; PASS if Δ ≥ -5)
- **C1 selectivity-preservation ≥ C2** (mean preservation Δ = +0.0pp; PASS if Δ ≥ 0)
- **C1 harmful-changes ≤ C2** (mean harmful_changes_rate Δ = +0.0pp; PASS if Δ ≤ 0)
