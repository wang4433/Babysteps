...
- Encoder: `dinov3_vitb16` spatial_mean (the deployed P1 encoder).
...
|---|---|---|---|---|---|---|
| `global_dino (spatial_mean)` | 768 | 0.500 | 0.533 | 0.983 ± 0.020 | 0.967 ± 0.017 | PASS |

## Verdict

- IntentHead-CV **0.967** vs majority **0.500**, shuffled **0.725**, gate **0.90**.
